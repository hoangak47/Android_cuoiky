...
import com.example.quanlyquancf.chatbot.ChatAdapter;
import com.example.quanlyquancf.chatbot.ClickListener;
import com.example.quanlyquancf.chatbot.Message;
import com.example.quanlyquancf.chatbot.RecyclerTouchListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = (ImageView)findViewById(R.id.imback);
        reset =(ImageView)findViewById(R.id.imreset);
        ...
        if (permission != PackageManager.PERMISSION_GRANTED) {
            Log.i(TAG, "Truy cập giọng nói bị từ chối");
            makeRequest();
        } else {
            Log.i(TAG, "Cho phép truy cập giọng nói");
        }
        ...
        switch (requestCode) {
            ...
            case RECORD_REQUEST_CODE: {
                ...
                if (grantResults.length == 0
                    ...
                    Log.i(TAG, "Quyền bị từ chối bởi người dùng");
                } else {
                    Log.i(TAG, "Quyền bị được cấp lại bởi người dùng");
                }
                return;
            }
